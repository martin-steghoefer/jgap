...
/**
 * The RandomGenerator interface provides an abstraction for the
 * random number implementation so that more rigorous or alternative
 * implementations can be provided as desired.
 */
