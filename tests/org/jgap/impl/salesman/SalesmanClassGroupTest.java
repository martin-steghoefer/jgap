...
public class SalesmanClassGroupTest extends TestCase {
    private m_testTravellingSalesman m_testTravellingSalesman = null;

    public SalesmanClassGroupTest(String name) {
        super(name);
    }
    ...
    public static Test suite() {
      TestSuite suite = new TestSuite(SalesmanClassGroupTest.class);
      return suite;
    }
