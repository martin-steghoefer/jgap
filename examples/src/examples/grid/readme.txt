...
java -cp ".;jgap-examples.jar;lib\log4j.jar;jgap.jar;lib\commons-cli-1.0.jar;lib\jcgrid.jar" examples.grid.fitnessDistributed.MyGAWorker -s SERVER -n myworker1
...
java -cp ".;jgap-examples.jar;lib\log4j.jar;jgap.jar;lib\commons-cli-1.0.jar;lib\jcgrid.jar" examples.grid.fitnessDistributed.ExampleClient -s SERVER
